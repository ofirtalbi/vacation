...
export class VactionBox extends Component<any, VactionBoxState> {
  ...
  private followVacation = () => {
    if (this.state.isLogin === false) {
      alert("You have to login to follow vacation");
      return;
    }
    ...
    fetch("http://localhost:3002/api/vacations/followVacation", options)
  ...
  private removeVacation = () => {
    ...
    fetch(
      `http://localhost:3002/api/vacations/delete/${vacationId}/${userId}`,
      options
    )
      .then((res) => {
